...
TEST_DIR = "/home/mimo/Desktop/MS CV/c3-V2/C3/MIT_small_train_3/test"
VALIDATION_DIR = "C3/MIT_small_train_2/test"
...
def objective(trail):
    ...
    # IMG_SIZE = trail.suggest_categorical("IMG_SIZE", available_image_sizes)

    run = wandb.init(
        project="week4_method3",
    )
    # try:
    ...
    model.save_weights(f"./models/{run.name}.h5")
...
if __name__ == "__main__":
    wandb_kwargs = {"project": "week4_method3"}
